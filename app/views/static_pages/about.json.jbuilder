...
json.payload do
  {
    ...
    projects:  [
      ...
      { name: 'Gesture Remote', url: project_item_path('universal-gesture-remote') },
      { name: 'Wordament Solver', url: project_item_path('wordament-solver') }
    ],
    portfolio: [
      { name: 'GitHub', url: 'https://github.com/KarthikMAM' },
      { name: 'LinkedIn', url: 'https://in.linkedin.com/in/KarthikMAM' },
      { name: 'HackerRank', url: 'https://hackerrank.com/karthikmam' },
      { name: 'Resume', url: 'http://www.slideshare.net/KarthikMAM/karthik-m-a-m-67611218?ref=https://www.linkedin.com/' }
    ],
    skills:    [
      { name: 'python', url: project_tags_path('python') },
      { name: 'c#', url: project_tags_path('c%23') },
      { name: 'wpf', url: project_tags_path('wpf') },
      { name: 'rails', url: project_tags_path('rails') },
      { name: 'ruby', url: project_tags_path('ruby') },
      { name: 'java', url: project_tags_path('java') },
      { name: 'javascript', url: project_tags_path('javascript') },
      { name: 'android', url: project_tags_path('android') },
