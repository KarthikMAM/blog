...
class ProjectsController < ApplicationController
  ...
  def index
    @projects = Project.includes(project_tags: [:tag])
  ...
  def edit
    @project = Project.includes(project_tags: [:tag])
  ...
  def update
    ...
    if @project.update_attributes(project_params)
      ...
      (old_tags - new_tags).each do |delete_tag|
        ProjectTag.find_by(project_id: @project.id, tag_id: Tag.find_by(name: delete_tag).id)
                  .destroy
      end
  ...
  def tags
    ...
    @projects = ProjectTag.includes(project: { project_tags: [:tag] })
